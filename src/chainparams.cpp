...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (      0, uint256("0x000002be4a05e7ce86e568cd6d106daca9d80bdeaa6564701efc2cd25a5bd86e"))
    ( 100000, uint256("0xc242774f40e337396ca50129416401c9720789114e6149fa1d47590d7fb4a982"))
    ( 200000, uint256("0xc997c67d39f4cac5d41fa8634cd155d32e9874678e4924140e058a8e39de5ca7"))
    ( 300000, uint256("0xd67bc7411053fd7962efd4c1fcb34214e5642eb42fbfa39c648691ddd9fce028"))
    ( 400000, uint256("0x9ac3cf2146259e05cae32bc10ddda00b00098f7307765e3a42d57aacbbd91444"))
    ( 500000, uint256("0x0cc5755284f8d6b95ee6aea518e2d8c3a00c0f828f5a384ebbfdfe011bcb65d9"))
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1584768926, // * UNIX timestamp of last checkpoint block
    1509501,    // * total number of transactions between genesis and last checkpoint (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("048d614ba7b6bb4092aae02536d7825044828ad8290b4422f6eb66677ab78b556a61af20bc32470c0ffbc385046a647cc25ba621bd99928d69be6d3fe874634d79");
        nDefaultPort = 15252;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Peps starting difficulty is 1 / 2^12
        ...
        nMaxMoneyOut = 74000000 * COIN;
        nLastPOWBlock = 200;
        nModifierUpdateBlock = 999999999;
        nZerocoinStartHeight = 1024000;
        nAccumulatorStartHeight = 1;
        nZerocoinStartTime = 1538310996;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f3d4d3f0cb226411855ac25a2d47e63dbdfb4e6b26a3de453a21fb7824104ffd341826e14455a29c73760c0cffe31ff8d87cf82b494417a70ffcf23d9d02e5ff") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1538310996;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3667246;
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        strSporkKey = "0414F669AC091EDE9237A4B6754C34A60AB13B26FFA38CBF3E61A07B9C05A6E85BA4C8589191D45F7D45B09C0D2A17865FA2F16132DB1922C73EE3DCAB43EBBC44";
        strObfuscationPoolDummyAddress = "PWUTQdgrQpdaUkPqPwm423ruYyynEA4kyC";
        nStartMasternodePayments = 1538310996;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Peps: 1 day
        nTargetSpacing = 1 * 60;  // Peps: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Peps: 1 day
        nTargetSpacing = 1 * 60;        // Peps: 1 minutes
